...
## Project Structure
    ...
    ├── testapiautoteammemb_69236  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_69236`
...
2. Clone this repo and `cd testapiautoteammemb_69236`
